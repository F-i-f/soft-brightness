...
m4_changecom({})m4_dnl
m4_define({gse_lib_project},
{# AUTOGENERATED FILE - DO NOT EDIT
# This file has been generated from meson-gse/meson.build.m4 and meson.build.meson-gse
...
extension_lib_convenience = files('meson-gse/lib/convenience.js')

extension_sources	  = files('src/extension.js')
extension_libs		  = []
extension_data		  = []
extension_schemas	  = []
extension_dbus_interfaces = []

extension_sources_prefs   = files('src/prefs.js')
if extension_sources_prefs != []
  extension_sources += extension_sources_prefs
endif

extension_data_stylesheet = files('src/stylesheet.css')
if extension_data_stylesheet != []
  extension_data += extension_data_stylesheet
endif

extension_schema_main = files('schemas/org.gnome.shell.extensions.'+ meson.project_name() + '.gschema.xml')
if extension_schema_main != []
  extension_schemas += extension_schema_main
endif
